...
public class RefreshAllCountriesInteractor implements Interactor {

    private final EventBus bus;
    private final CountriesRepository repository;

    public RefreshAllCountriesInteractor(EventBus bus, CountriesRepository repository) {
        this.bus = bus;
    ...
    @Override public void execute() {
        ...
        try {
            List<Country> countries = repository.refreshAllCountries();
